  ...
  %>
                                                    ...
                                                    <form action="Attacker3.jsp" method="get" name="form1">
                                                        <table width="478" border="0" align="center">
                                                            <tr>
                                                                <td width="223" bgcolor="#FF0000">
                                                                    <div align="center" class="style6"><span class="style5">Title</span></div>
                                                                </td>
                                                                <td width="245"><label> <input required name="t1"type="text" value="<%=encryptedTitle%>" size="25" /> </label></td>
                                                            </tr>

                                                            <tr>
                                                                <td height="34" bgcolor="#FF0000">
                                                                    <div align="center" class="style6"><span class="style5">Biometric Image Name  </span></div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="#FF0000">
                                                                    <div align="center" class="style6"><span class="style5">Discription</span></div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td height="34" bgcolor="#FF0000">
                                                                    <div align="center" class="style6"><span class="style5">Digital Sign </span></div>
                                                                </td>
