            ...
            <div class="content_resize">
                <div class="mainbar">
                    ...
                    <div class="article">
                        ...
                        <p>&nbsp;</p>
                        <p>
                            <h2><span class="style4"><%=request.getParameter("name")%></span> Digital Sign is <span class="style4"><%=request.getParameter("mac")%></span></h2>
                        </p>
		 ...
		 %>
                ...
                <div class="sidebar">
                    <div class="gadget">
                        ...
                        <div class="clr"></div>
                        <ul class="sb_menu">
                            <li><a href="auditorMain.jsp"> Main</a></li>
