    ...
    <div class="main">
        ...
        <div class="content">
            <div class="content_resize">
                        ...
                        <p>
                            ...
                            <form action="c_Request.jsp" method="post" name="form1" id="form1">
                                <table width="430" border="0" align="center">
                                    <tr>
                                        <td width="157" bgcolor="#FF0000">
                                            <div align="center" class="style17">Enter File Name </div>
                                        </td>
                                        <td width="263"><label>
                      <div align="center">
                        <input required name="t1" type="text" size="25" />
                      </div>
                    </label></td>
                                    </tr>

                                    <tr>
                                        <td height="41" bgcolor="#FF0000">
                                            <div align="center" class="style17">Secret Key </div>
                                        </td>
                                        <td>
                                            <div align="center">
                ...
                <div class="sidebar">
                    <div class="gadget">
                        <h2 class="star"><span></span> UsersMenu</h2>
