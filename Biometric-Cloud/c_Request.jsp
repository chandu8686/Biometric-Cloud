        ...
        <div class="content">
			...
			%>
                                                ...
                                                <table width="478" border="0" align="center">
                                                    <tr>
                                                        <td width="223" height="51" bgcolor="#FF0000">
                                                            <div align="center" class="style28"><span class="style27">Enter File Name </span></div>
                                                        </td>
                                                        <td width="245"><label>
                  <input required name="t1" type="text" value="<%=decryptedName%>" size="25" />
                                                    ...
                                                    <tr>
                                                        <td height="35" bgcolor="#FF0000">
                                                            <div align="center" class="style28"><span class="style27">Secret Key </span></div>
                                                        </td>
