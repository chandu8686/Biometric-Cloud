    ...
    <div class="main">
        ...
        <div class="content">
                                        ...
                                        <TABLE ALIGN="center" STYLE="margin:0 0 0 30px;">
                                            <TR>
                                                <TD width="174" bgcolor="#FF0000">
                                                    <P align="center" class="style18"><span class="style10">Enter Keyword to Search &nbsp;</span>&nbsp;</P>
                                                </TD>
                                                <TD width="165" bgcolor="#FF0000">
                                                    <div align="center" class="style18">
                                                        <INPUT TYPE="text" name="keyword" />
                                                    </div>
                                                </TD>
                                                <TD width="72" bgcolor="#FF0000">
                                                    <INPUT name="submit" TYPE="submit" STYLE="width:50px; height:25px;" VALUE="GO" />
                                                </TD>
                                            </TR>
                                            <TR>
                                                <TD COLSPAN="3" bgcolor="#FF0000">
                                                    <P align="center" class="style14">[ searching content Based on Image Description ] </P>
                                                </TD>
                                            </TR>
                                        </TABLE>
                                    </DIV>
          ...
          <input  name="image " type="image " src="w_ProfilePic.jsp?id=<%=i%>&type=
                                                <%="serverimages"%>" style="width:110px; height:100px;" /></a>
                    </div>
                    </td>

                    <td width="148" valign="baseline" height="31" style="color: #2c83b0;">
                        <p>&nbsp;</p>
                        <div align="center" class="style15 style4 style5 style10 style13">
                            <%=encryptedTitle%>
                        </div>
                    </td>
                    <td width="183" valign="baseline" height="31" style="color: #2c83b0;">
                        <p>&nbsp;</p>
                        <div align="center" class="style15 style4 style5 style10 style13">
                            <a href="c_SearchImages1.jsp?imgName=<%=encryptedName%>">
                                <%=encryptedName%>
                            </a>
                        </div>
                    </td>
                    <td width="142" valign="baseline" height="31" style="color: #2c83b0;">
                        <p>&nbsp;</p>
                        <div align="center" class="style15 style4 style5 style10 style13">
                            <%=rank%>
                        </div>
                    ...
                    <td width="142" valign="baseline" height="31" style="color: #2c83b0;">
                        <p>&nbsp;</p>
                        <div align="center" class="style15 style4 style5 style10 style13">
                            <a href="c_ViewComments.jsp?id=<%=i%>&keyword=<%=input%>">
                                <%="View"%>
                            </a>
                        </div>
                    </td>
