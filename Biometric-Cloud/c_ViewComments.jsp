...
%>
               ...
               <input  name="image2" type="image" src="w_ProfilePic.jsp?id=<%=id%>&type=<%="serverimages"%>" style="width:150px; height:150px;"  />
                            ...
                            <tr>
                                <td width="184" height="45" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                    <div align="left" class="style18 style16" style="margin-left:20px;"><strong> ID </strong></div>
                                </td>
                                <td width="142"><span class="style15 style10"> &nbsp;&nbsp;<%=id%></span></td>
                            </tr>
                            <tr>
                                <td width="184" height="48" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                    <div align="left" class="style20" style="margin-left:20px;">Biometric Image Title </div>
                                </td>
                            ...
                            <tr>
                                <td width="184" height="39" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                    <div align="left" class="style20" style="margin-left:20px;">Biometric Image Name </div>
                                </td>
                            ...
                            <tr>
                                <td width="184" height="25" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                    <div align="left" class="style20" style="margin-left:20px;">Rank</div>
                                </td>
                            ...
                            <tr>
                                <td width="144" height="30" colspan="1" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                    <div align="center" class="style18 style10 style8"><strong>Commented By</strong></div>
                                </td>
                                <td width="144" height="30" colspan="1" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                    <div align="center" class="style18 style8 style10"><strong>Comments Details </strong></div>
                                </td>
                                <td width="144" height="30" colspan="1" valign="middle" bgcolor="#FF0000" style="color: #9e4c66;">
                                    <div align="left" class="style20" style="margin-left:20px;">
	...
	while ( rs2.next() )
	 ...
	 %>
                                <tr>
                                    <td height="36">
                                        <div align="center"><span class="style15">&nbsp;&nbsp;<%=user%></span></div>
                                    </td>
                                    <td>
                                        <div align="center"><span class="style15">&nbsp;&nbsp;<%=comment%></span></div>
                                    </td>
                                    <td>
                                        <div align="center"><span class="style15">&nbsp;&nbsp;<%=date%></span></div>
                                    </td>
                                    <tr> </tr>
