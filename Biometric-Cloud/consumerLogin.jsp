                ...
                <div class="mainbar">
                    ...
                    <div class="article">
                        ...
                        <p><img src="images/Login.png" width="179" height="179" />
                            <form action="authentication.jsp?type=<%=" consumer "%>" method="post" id="leavereply">
                                <ol>
                                    <li>
                        ...
                        <p align="right" class="style2"><span class="style7">New User ?</span> <strong><a href="c_Register.jsp">Register</a></strong> </p>
                        <div class="clr"></div>
                    </div>
                </div>
                <div class="sidebar">
