            ...
            <div class="content_resize">
                <div class="mainbar">
                    ...
                    <div class="article">
                        ...
                        <p>
                            <form id="form1" name="form1" method="post" action="o_AddImage1.jsp">
                                <table width="600" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; display:inline; margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
                                    ...
                                    <tr>
                                        <td width="244" height="45" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                            <div align="left" class="style3 style7" style="margin-left:20px;"><strong>  Title </strong></div>
                                        </td>
                                        <td width="356" valign="middle" height="45" style="color:#000000;">
                                            <div align="left" style="margin-left:20px;"><input type="text" name="title"></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="356" valign="middle" height="45" style="color:#000000;">
                                            <div align="left" style="margin-left:20px;"><input type="text" name="name"></div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="356" valign="middle" height="45">
                                    ...
                                    <div>
                                        <tr>
                                            <td height="45" colspan="2" id="learn_more" align="center" style="color:#FFFFFF;"><input type="submit" value="Submit" style="width:100px; height:35px; background-color:#000000; color:#FFFFFF;" />&nbsp;&nbsp;<input type="reset" name="Reset" style="width:100px; height:35px; background-color:#000000; color:#FFFFFF;"
                                                /></td>
                                        </tr>
                                    </div>
                                </table>
