						 ...
						 <input  name="image" type="image" src="w_ProfilePic.jsp?id=<%=i%>&type=<%="owner"%>" style="width:200px; height:200px;"  />
                                            ...
                                            <tr>
                                                <td width="127" height="28" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                                    <div align="left" class="style3 style14 style7 style8" style="margin-left:20px;"><strong>E-Mail</strong></div>
                                                </td>
                                                <td width="182" valign="middle" height="28" style="color:#000000;">
                                                    <div align="left" class="style6" style="margin-left:20px;">
                                                        <%out.println(s2);%>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="127" height="28" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                                    <div align="left" class="style3 style14 style7 style8" style="margin-left:20px;"><strong>Mobile</strong></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td width="127" height="28" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                                    <div align="left" class="style3 style14 style7 style8" style="margin-left:20px;"><strong>Address</strong></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td width="127" height="23" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                                    <div align="left " class="style3 style14 style7 style8" style="margin-left:20px;"><strong>Date Of Birth</strong></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td width="127" height="33" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;">
                                                    <div align="left" class="style3 style14 style7 style8" style="margin-left:20px;"><strong>Status</strong></div>
                                                </td>
                                                <td width="182" align="left" valign="middle" height="33" style="color: #2c83b0;">
                                                    <div align="left">
                                                        <div align="left" class="style6" style="margin-left:20px;">
                                                            <%out.                       println(s6);%>
                                                        </div>
