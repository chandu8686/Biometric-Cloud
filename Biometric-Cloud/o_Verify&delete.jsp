	   ...
	   title1 = rs1.getString(2);
		...
		String encryptedName1 = new String(Base64.decode(name1.getBytes()));	 
                                                ...
                                                <table width="465" border="0">
                                                    <tr>
                                                        <td width="245" bgcolor="#FF0000">
                                                            <div align="center" class="style11 style8"><strong> ID </strong></div>
                                                        </td>
                                                        <td width="210"><label>
          <input type="text" name="t" value="<%=i%>" readonly>
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#FF0000">
                                                            <div align="center" class="style11 style8"><strong>Biometric Image Title </strong></div>
                                                        </td>
                                                        <td><label>
          <input type="text" name="t1" value="<%=encryptedTitle%>" readonly>
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#FF0000">
                                                            <div align="center" class="style11 style8"><strong>Biometric Image Name </strong></div>
                                                        </td>
                                                        <td><label>
          <input type="text" name="t2" value="<%=encryptedName%>" readonly>
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#FF0000">
                                                            <div align="center" class="style11 style8"><strong>Attacker Name</strong></div>
                                                        </td>
                                                        <td><label>
          <input type="text" name="t2" value="<%=attacker%>" readonly>
                                                    ...
                                                    <tr>
                                                        <td height="101" bgcolor="#FF0000">
                                                            <div align="center" class="style11 style8"><strong>Attacked Type</strong></div>
                                                        </td>
                                                        <td><label>
