...
<body>
    <div class="main">
        ...
        <div class="content">
          ...
          <input  name="image " type="image " src="w_ProfilePic.jsp?id=<%=id%>&type=
                                            <%="serverimages"%>" style="width:110px; height:100px;" /></a>
                    </div>
                    </td>

                    <td valign="baseline" height="0">
                        <p class="style3 style10">&nbsp;</p>
                        <div align="center" class="style3 style10">
                    ...
                    <td valign="baseline" height="0">
                        <p class="style3">&nbsp;</p>
                        <div align="center" class="style3"><a href="w_DSign.jsp?mac=<%=mac%>&name=<%=encryptedName%>&type=<%=" img "%>">View</a></div>
                    </td>
                    </tr>
