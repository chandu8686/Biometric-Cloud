            ...
            <div class="header_resize">
                ...
                <div class="menu_nav">
                    <ul>
                        ...
                        <li><a href="consumerLogin.jsp">User</a></li>
                        <li class="active"><a href="webServerLogin.jsp"><span>Cloud</span></a></li>
                        <li></li>
                        <li></li>
                    </ul>
                </div>
                        ...
                        <p><img src="images/Login.png" width="179" height="179" />
                            <form action="authentication.jsp?type=<%=" server "%>" method="post" id="leavereply">
                                <ol>
                                    ...
                                    <li>
                                        <span class="style7"><label for="email"><span class="style4">Password (required)</span></label>
                ...
                <div class="sidebar">
                    <div class="gadget">
                        ...
                        <ul class="sb_menu">
                            ...
                            <li><strong><a href="ownerLogin.jsp">Owner</a></strong></li>
                            <li><strong><a href="consumerLogin.jsp">Users</a></strong></li>
                            <li><strong><a href="webServerLogin.jsp">Cloud Server</a></strong></li>
